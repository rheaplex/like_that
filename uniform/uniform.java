import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class uniform extends PApplet {/*
    uniform - Art computing piece.
...
float min_ghost_x = -100;
float max_ghost_x = 100;
float min_ghost_y = -100;
float max_ghost_y = 100;

float min_ghost_start_t = 0.0f;
float max_ghost_start_t = 0.5f;

float min_ghost_size = 5;
float max_ghost_size = 200;
...
static public void main(String args[]) {   PApplet.main(new String[] { "uniform" });}}