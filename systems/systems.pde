...
int num_colours = 4;
color[] colours = new color [num_colours];
...
void setup_colours ()
{
  colours[0] = color (255, 0.0, 0.0, 240);
  colours[1] = color (255, 255, 0.0, 200);
  colours[2] = color (0.0, 0.0, 255, 210);
  colours[3] = color (0.0, 0.0, 0.0, 245);  
}
