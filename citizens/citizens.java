import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class citizens extends PApplet {/*
    citizens - Art computing piece.
...
int min_object_z = -100;
int max_object_z = 100;
...
public void gen_objects ()
{
  ...
  for (int i = 0; i < num_objects; i++) 
  {
   ...
   zs[i] = random (min_object_z, max_object_z); 
...
public void draw ()
{
  ...
  camera (-(canvas_width /2.0f), -(canvas_height /2.0f), canvas_width,
          0, 0, 0,
          0, 1, 0);
  noStroke ();
  rectMode (CENTER);
...
static public void main(String args[]) {   PApplet.main(new String[] { "citizens" });}}